...
\begin{itemize}
	...
	\item \textbf{Dirección inicial del búfer de rececpción}: Búfer utilizado como búfer de envío en el \textit{scatter}.
...
Una vez realizada esta operación, hay que desempaquetar (paso inverso al empaquetado anterior). Para ello se utilizará un bucle como el desempaquetado, pero esta vez se utilizará \texttt{MPI\_Unpack} con los siguientes parámetros:
\begin{itemize}
